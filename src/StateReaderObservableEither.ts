 ...
 * @since 0.6.12
 */
export const chainW = <A, S, R2, E2, B>(f: (a: A) => StateReaderObservableEither<S, R2, E2, B>) => <R1, E1>(
  ma: StateReaderObservableEither<S, R1, E1, A>
): StateReaderObservableEither<S, R1 & R2, E1 | E2, B> => s1 =>
  pipe(
    ma(s1),
    ROE.chainW(([a, s2]) => f(a)(s2))
  )
